                ...
                <div className="flex rounded-lg overflow-hidden border border-gray-250 dark:border-[#1a2d29]">
                  {['bar', 'line', 'area'].map(type => (
                    <button
                      ...
                      className={`flex-1 text-[10px] font-black py-1.5 uppercase transition-colors cursor-pointer border-none ${
            ...
            <div className="grid grid-cols-2 gap-x-6 gap-y-2 w-full mt-6">
              {data.deptData.map((item, idx) => (
                <div 
                  ...
                  className={`flex items-center justify-between text-xs font-bold cursor-pointer p-1.5 rounded-lg transition-colors ${
                    drilldownDept === item.name 
              ...
              >
                ...
                <div className="text-right shrink-0">
                  ...
                  <span className={`text-[8px] font-black uppercase px-2 py-0.5 rounded ${
                    act.status === 'approved' || act.status === 'completed' || act.status === 'active'
                ...
                <tr key={i} className="transition-colors hover:bg-slate-50 dark:hover:bg-[#111c18]/30">
                  ...
                  <td className="px-6 py-4 text-center">
                    <span className={`px-2.5 py-0.5 rounded-full text-[9px] font-black uppercase tracking-wider ${
                      row.status === 'active' || row.status === 'Active' || row.status === 'Present'
                        ? 'bg-green-100 text-green-700 dark:bg-green-950/20 dark:text-green-400'
