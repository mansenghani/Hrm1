    ...
    return (
        <div className="space-y-12 animate-in fade-in duration-500 pb-20">
            ...
            <div className="flex justify-between items-end">
                <div>
                    <h1 className="text-5xl font-black text-[#1E2026] tracking-tighter leading-none mb-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {[
                    ...
                    <div key={i} className="bg-white p-10 border border-[#E6E8EA] rounded-[5px] hover:shadow-2xl transition-all group relative overflow-hidden active:scale-95 cursor-default">
            ...
            <div className="grid grid-cols-12 gap-8 w-full">
                {/* TEAM SECTION */}
                <div className="col-span-12 lg:col-span-7 bg-white border border-[#E6E8EA] rounded-[5px] p-12 shadow-sm">
                    ...
                    <div className="space-y-6">
                        {!stats.team || stats.team.length === 0 ? (
                            <p className="text-center py-10 text-[11px] font-black text-[#848E9C] uppercase tracking-widest border-2 border-dashed border-[#F5F5F5] rounded-[5px]">No operational nodes assigned</p>
                        ) : (
                            stats.team.map((emp) => (
                                <div key={emp._id} className="flex items-center justify-between p-6 rounded-[5px] bg-[#F9FAFC] border border-[#E6E8EA] hover:border-[#3E74FF] transition-all group">
                ...
                <div className="col-span-12 lg:col-span-5 bg-[#1E2026] rounded-[5px] p-12 text-white relative overflow-hidden shadow-2xl">
                    ...
                    <div className="space-y-5 relative z-10">
                        {Array.isArray(stats.tasks) && stats.tasks.slice(0, 5).map((task) => (
                            <div key={task._id} className="p-6 rounded-[5px] bg-white/5 border border-white/5 hover:bg-white/[0.08] transition-all group cursor-pointer" onClick={() => navigate('/manager/tasks')}>
                    ...
                    <button
                        ...
                        className="w-full mt-10 py-6 bg-white flex items-center justify-center gap-3 rounded-[5px] text-[#1E2026] text-[11px] font-black uppercase tracking-[0.3em] hover:bg-[#F0B90B] transition-all shadow-xl"
                    >
