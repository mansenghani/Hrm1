    ...
    <div className="space-y-12 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          ...
          { label: 'Active Syncs', val: stats.activeNodes, change: stats.activeNodes > 0 ? '+Active' : 'Offline', bullish: stats.activeNodes > 0, icon: Activity },
          { label: 'Network Depth', val: stats.departments, change: 'Operational', bullish: true, icon: Building2 },
